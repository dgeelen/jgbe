...
public class CPU
{
  ...
  static final protected int execute() {
   ...
   switch ( op ) {
    ...
    case (0xfe) : { t_vol = ((read(PC++))); { t_acc = A - (t_vol); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; }; return cycles;
	case (0xb8) : { t_acc = A - (B); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (B) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+1: { t_acc = A - (C); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (C) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+2: { t_acc = A - (D); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (D) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+3: { t_acc = A - (E); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (E) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+4: { t_acc = A - (H); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (H) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+5: { t_acc = A - (L); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (L) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
	case (0xb8)+6: { t_vol = (read(((H<<8)|L))); { t_acc = A - (t_vol); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; }; return cycles;
	case (0xb8)+7: { t_acc = A - (A); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (A) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; return cycles;
    ...
    case (0xC6) : { t_vol = ((read(PC++))); { t_acc = (A) + (t_vol); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; }; return cycles;
	case (0x80) : { t_acc = (A) + (B); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (B) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+1: { t_acc = (A) + (C); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (C) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+2: { t_acc = (A) + (D); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (D) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+3: { t_acc = (A) + (E); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (E) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+4: { t_acc = (A) + (H); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (H) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+5: { t_acc = (A) + (L); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (L) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
	case (0x80)+6: { t_vol = (read(((H<<8)|L))); { t_acc = (A) + (t_vol); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; }; return cycles;
	case (0x80)+7: { t_acc = (A) + (A); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & (((A) ^ (A) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << 4); (A) = ((t_acc)&0xff); };; return cycles;
    case (0xCE) : { t_vol = ((read(PC++))); { t_acc = A + (t_vol) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; }; return cycles;
	case (0x88) : { t_acc = A + (B) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (B) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+1: { t_acc = A + (C) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (C) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+2: { t_acc = A + (D) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (D) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+3: { t_acc = A + (E) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (E) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+4: { t_acc = A + (H) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (H) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+5: { t_acc = A + (L) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (L) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
	case (0x88)+6: { t_vol = (read(((H<<8)|L))); { t_acc = A + (t_vol) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; }; return cycles;
	case (0x88)+7: { t_acc = A + (A) + ((F&CF_Mask)>>CF_Shift); F = (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (A) ^ ((t_acc)&0xff)) << 1)) | ((((t_acc)>>8)) << CF_Shift); A = ((t_acc)&0xff); }; return cycles;
    case (0xD6) : { t_vol = ((read(PC++))); { { t_acc = A - ((t_vol)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((t_vol)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; }; return cycles;
	case (0x90) : { { t_acc = A - ((B)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((B)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+1: { { t_acc = A - ((C)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((C)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+2: { { t_acc = A - ((D)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((D)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+3: { { t_acc = A - ((E)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((E)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+4: { { t_acc = A - ((H)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((H)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+5: { { t_acc = A - ((L)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((L)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
	case (0x90)+6: { t_vol = (read(((H<<8)|L))); { { t_acc = A - ((t_vol)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((t_vol)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; }; return cycles;
	case (0x90)+7: { { t_acc = A - ((A)); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ ((A)) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); }; A = ((t_acc)&0xff); }; return cycles;
    case (0xDE) : { t_vol = ((read(PC++))); { t_acc = A - (t_vol) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; }; return cycles;
	case (0x98) : { t_acc = A - (B) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (B) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+1: { t_acc = A - (C) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (C) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+2: { t_acc = A - (D) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (D) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+3: { t_acc = A - (E) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (E) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+4: { t_acc = A - (H) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (H) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+5: { t_acc = A - (L) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (L) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	case (0x98)+6: { t_vol = (read(((H<<8)|L))); { t_acc = A - (t_vol) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (t_vol) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; }; return cycles;
	case (0x98)+7: { t_acc = A - (A) - ((F&CF_Mask)>>CF_Shift); F = NF_Mask | (( (((t_acc)&0xff)) != 0 ? 0 : ZF_Mask )) | (HC_Mask & ((A ^ (A) ^ ((t_acc)&0xff)) << 1)) | (CF_Mask&(t_acc>>8)); A = ((t_acc)&0xff); }; return cycles;
	...
	case (0x38)+6: { t_acc = read(((H<<8)|L)) | ((F&CF_Mask)<<4); F = ShTables. SRL_flag[t_acc]; write(((H<<8)|L), ShTables. SRL_val[t_acc]); }; return cycles;
      case 0x30+0: B = Tables.swap[B]; F = ( (B) != 0 ? 0 : ZF_Mask ); return cycles;
	case 0x30+1: C = Tables.swap[C]; F = ( (C) != 0 ? 0 : ZF_Mask ); return cycles;
	case 0x30+2: D = Tables.swap[D]; F = ( (D) != 0 ? 0 : ZF_Mask ); return cycles;
	case 0x30+3: E = Tables.swap[E]; F = ( (E) != 0 ? 0 : ZF_Mask ); return cycles;
	case 0x30+4: H = Tables.swap[H]; F = ( (H) != 0 ? 0 : ZF_Mask ); return cycles;
	case 0x30+5: L = Tables.swap[L]; F = ( (L) != 0 ? 0 : ZF_Mask ); return cycles;
