...
public class Cardridge
{
	 ...
	 */
	{
		...
		{
			case 0x00: ROM = new int[2][0x81]   /* 32KByte (no ROM banking) */;
			case 0x01: ROM = new int[4][0x81]   /* 64KByte (4 banks) */;
			case 0x02: ROM = new int[8][0x81]   /* 128KByte (8 banks) */;
			case 0x03: ROM = new int[16][0x81]  /* 256KByte (16 banks) */;
			case 0x04: ROM = new int[32][0x81]  /* 512KByte (32 banks) */;
			case 0x05: ROM = new int[64][0x81]  /* 1MByte (64 banks)  - only 63 banks used by MBC1 */;
			case 0x06: ROM = new int[128][0x81] /* 2MByte (128 banks) - only 125 banks used by MBC1 */;
			case 0x07: ROM = new int[256][0x81] /* 4MByte (256 banks) */;
			case 0x52: ROM = new int[72][0x81]  /* 1.1MByte (72 banks) */;
			case 0x53: ROM = new int[80][0x81]  /* 1.2MByte (80 banks) */;
			case 0x54: ROM = new int[96][0x81]  /* 1.5MByte (96 banks) */;
		} // switch(header[0x0148])

		// Determine RAM size
		switch(first_rom_bank[0x0149])
		{
			case 0x00: RAM = null;                /* None */;
			case 0x01: RAM = new int[0][2 * 1024] /* 2KBytes */;
			case 0x02: RAM = new int[0][8 * 1024] /* 8Kbytes */;
			case 0x03: RAM = new int[4][8 * 1024] /* 32 KBytes (4 banks of 8KBytes each) */;
